...
import { paginationSongs } from '../../redux/songReducer';
import { paginationGenres } from '../../redux/genresReducer';
import { createNewAlbum, getAlbumById } from '../../redux/albumReducer';
import { useSnackbar } from 'notistack';
import { useParams } from 'react-router';
import { isObject } from '../../utils/UtilsFunction';
                    ...
                    <div className="ms_pro_form">
                        <div className="form-group">
                            <TextField
                                ...
                                error={errors != undefined ? errors.txtAlbumName : false}
                                onChange={handleChangeInput}
                        ...
                        <div className="form-group">
                            <Autocomplete
                                ...
                                renderInput={(params) => (
                                    <TextField
                                        helperText="Không được để trống"
                                        error={errors != undefined ? errors.txtAlbumArtist : false}
                                        onBlur={OnBlurErrors}
                                        name="txtAlbumArtist"
                                        {...params}
                                        onChange={handleChangeTextFieldArtist}
                                        variant="outlined"
                                        label="Nghệ sĩ"
                                        placeholder="Nghệ sĩ"
                                    />
                            ...
                            <Autocomplete
                                ...
                                renderInput={(params) => (
                                    <TextField
                                        ...
                                        name="txtGenres"
                                        helperText="Không được để trống"
                                        error={errors != undefined ? errors.txtGenres : false}
                                        {...params}
                                        onBlur={OnBlurErrors}
                                        variant="outlined"
                                        label="Thể loại"
                        ...
                        <div className="form-group">
                            <Autocomplete
                                ...
                                renderInput={(params) => (
                                    <TextField
                                        error={errors != undefined ? errors.txtSongArtist : false}
                                        {...params}
                                        helperText="Không được để trống"
                                        name="txtSongArtist"
                                        onBlur={OnBlurErrors}
