...
//                 ...form,
//                 image: current.image,
//                 txtBirthday: current.birthDay,
//                 txtCountryActive: current.countryActive,
//                 txtFullName: current.fullName,
//                 txtDescription: current.description,
//                 txtGender: current.gender
//             });
//         }
//     }, [artistReducer.currentArtist]);
...
//                                 error={error != null ? error.txtFullName : false}
//                                 name="txtFullName"
//                                 onChange={handleChangeInput}
...
//                                 renderInput={(params) => (
//                                     <TextField
//                                         error={error != null ? error.txtGender : false}
//                                         onChange={handleChangeInput}
...
//                             <label htmlFor="birthDay">Sinh nhật</label>
//                             <input
//                                 value={form.txtBirthday}
//                                 id="birthDay"
//                                 placeholder="Hãy chọn ngày sinh"
//                                 onChange={handleChangeInput}
//                                 name="txtBirthday"
//                                 style={{ width: '100%', height: '52px', borderRadius: '5px', border: '1px solid #c4c4c4', outline: '#007bff' }}
//                                 type="date"
//                             />
//                             <span style={error.txtBirthday ? { display: '' } : { display: 'none' }} className="error-form">Không được để trống</span>
//                         </div>
...
//                             <label htmlFor="countryActive">Quốc gia hoạt động</label>
//                             <select
//                                 value={form.txtCountryActive}
//                                 onChange={handleChangeInput}
//                                 name="txtCountryActive"
//                                 id="countryActive"
//                                 style={{ width: '100%', height: '52px', borderRadius: '5px', border: '1px solid #c4c4c4', outline: '#007bff' }}
//                             >
//                                 {country.map((e, i) => (
...
//                             <label>Mô tả</label>
//                             <textarea
//                                 value={form.txtDescription}
//                                 onChange={handleChangeInput}
//                                 name="txtDescription"
//                                 rows="4"
//                                 style={{ width: "100%", outlineColor: '#3f51b5', fontSize: 'small' }}
//                                 className="form"
//                             />
//                         </div>
//                         <div className="form-group">
...
const ArtistForm = (props) => {
    ...
    const checkData = () => {
        ...
        if (form.txtBirthday.trim().length == 0) {
            txtBirthday = true;
            isValid = false;
        }
        if (form.txtCountryActive.trim().length == 0) {
